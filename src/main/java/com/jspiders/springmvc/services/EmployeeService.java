...
public class EmployeeService {
	...
	public EmployeePOJO addEmployee(String name,String email, long contact,String designation,
									double salary) {
	...
	public EmployeePOJO updateEmployee(int id, String name, String email, long contact,
										String designation, double salary) {
		EmployeePOJO empployee=repository.updateEmployee(id, name, email, contact, designation, salary);
		return empployee;
	}
}
